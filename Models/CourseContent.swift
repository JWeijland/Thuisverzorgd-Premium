...
// MARK: - All course content for Thuisverzorgd Training Institute
...
""")
            ...
            quiz("Eindtoets — Basis Buddy", symbol: "checkmark.seal.fill", [
                q("Wat is de minimale leeftijd om buddy te worden bij Thuisverzorgd?",
                  ["16 jaar", "18 jaar", "21 jaar", "Geen minimum"], correct: 1,
                  "Thuisverzorgd werkt met meerderjarige zorgverleners. De minimumleeftijd is 18 jaar, conform het arbeidsrecht en de vereisten van de VOG."),
                ...
                q("Hoe lang is een VOG bij Thuisverzorgd geldig?",
                  ["1 jaar", "2 jaar", "3 jaar", "5 jaar"], correct: 2,
                  "Bij Thuisverzorgd is de VOG 3 jaar geldig, waarna hernieuwing verplicht is. Dit is in lijn met richtlijnen van VWS voor informele zorgverleners."),
    ...
    static let course_basisWelkom_kort: Course = Course(
        ...
        progressPercent: 0,
        unlocked: true,
        summary: "Speciaal voor zorggediplomeerden: alleen de Thuisverzorgd-specifieke normen, gedragscode en app-gebruik. Communicatie en zorgvaardigheden worden als bekend verondersteld.",
        modules: [
            video("Welkom bij Thuisverzorgd", symbol: "heart.text.square.fill", duration: 8, """
In deze verkorte introductie maak je kennis met de missie en spelregels van Thuisverzorgd. Omdat jij al een erkend zorgdiploma hebt, slaan we de basis zorgvaardigheden over. We focussen op wat Thuisverzorgd specifiek van je vraagt: hoe werkt de app, wat zijn onze gedragsnormen, en hoe ga je om met het bezoekprotocol.

Belangrijk: ook met een diploma blijf jij als buddy verantwoordelijk voor het naleven van de Thuisverzorgd-gedragscode. Jouw ervaring is een groot voordeel — maar de normen van ons platform gelden voor iedereen gelijk.
"""),
            reading("Thuisverzorgd Gedragscode", symbol: "checkmark.shield.fill", duration: 5, [
                section("Wat verwacht Thuisverzorgd van jou", symbol: "person.badge.shield.checkmark.fill", """
...
Alles wat je ziet, hoort of leest tijdens een bezoek valt onder je beroepsgeheim. Deel nooit informatie over een cliënt via persoonlijke kanalen — ook niet met vrienden of familie, ook niet 'anoniem'. Gebruik uitsluitend de Thuisverzorgd app voor overdracht en communicatie.
...
""")
            ...
            quiz("Eindtoets — Thuisverzorgd Gedragscode", symbol: "checkmark.seal.fill", [
                q("Je hebt een MBO Helpende diploma. Een oudere vraagt je om een injectie toe te dienen. Wat doe je?",
                  ...
                  "Injecties zijn voorbehouden handelingen waarvoor een BIG-registratie vereist is. Ook met een Helpende diploma — Niveau 3 — mag je dit niet uitvoeren. Thuisverzorgd werkt met strikte niveaubevoegdheden."),
...
Informatie over de oudere deel je alleen met wie het nodig heeft voor de directe zorgverlening: de familie die via de app gekoppeld is en Thuisverzorgd zelf. Je deelt niets met vrienden, klasgenoten of andere buddies.
...
De Thuisverzorgd-app gebruikt versleutelde verbindingen voor alle communicatie. Gebruik de app alleen op uw eigen apparaat. Deel je inloggegevens niet met anderen — ook niet met een collega-buddy.

Stuur nooit medische informatie via WhatsApp of e-mail. Als de familie via de app communiceert, gebruik dan alleen dat kanaal. Bij een datalek of verlies van je telefoon: meld dit direct via hulp@thuisverzorgd.nl.
""")
            ]),
...
Maar dit is een hoge drempel. Twijfel je? Bel Thuisverzorgd. Ga nooit op eigen houtje informatie doorgeven buiten de app om — er zijn hiervoor meldprotocollen.
"""),
...
Meld dit onmiddellijk bij Thuisverzorgd via hulp@thuisverzorgd.nl. Thuisverzorgd heeft wettelijk 72 uur om een datalek te melden bij de Autoriteit Persoonsgegevens. Hoe sneller jij meldt, hoe sneller de schade beperkt kan worden.
""")
            ]),
            quiz("Eindtoets — Privacy & AVG", symbol: "lock.shield.fill", [
                ...
                q("Met wie mag je informatie over de cliënt delen?",
                  ["Met andere buddies zodat ze weten wat ze kunnen verwachten", "Alleen met gekoppelde familie en Thuisverzorgd via de beveiligde app", "Met de huisarts als je je zorgen maakt", "Met je medestudenten voor een casusopdracht"], correct: 1,
                  "Informatie delen buiten de gekoppelde familie en Thuisverzorgd is een privacyschending, ook als je goede bedoelingen hebt. Voor zorgen: meld altijd via de app."),
                q("Een familielid van een andere cliënt vraagt hoe het gaat met jouw cliënt. Wat doe je?",
                  ["Vriendelijk vertellen dat het goed gaat", "Zeggen dat je geen informatie deelt over anderen", "Doorverwijzen naar Thuisverzorgd", "Alleen zeggen 'geen bijzonderheden'"], correct: 1,
                  "Elke informatie over een cliënt is vertrouwelijk, ook het feit dat het 'goed gaat'. Je deelt nooit iets zonder toestemming van de cliënt of Thuisverzorgd."),
                q("Wat doe je als je telefoon verloren gaat en de Thuisverzorgd-app erop staat?",
                  ["Afwachten of je hem terugvindt", "Niets — de app heeft een wachtwoord", "Direct melden bij Thuisverzorgd via hulp@thuisverzorgd.nl", "Je account verwijderen en opnieuw aanmaken"], correct: 2,
                  "Bij verlies of diefstal van een apparaat met toegang tot patiëntgegevens moet je dit direct melden. Thuisverzorgd kan dan de toegang intrekken om misbruik te voorkomen."),
...
Overtreding van de Wet BIG is niet alleen een fout binnen Thuisverzorgd, maar kan ook strafrechtelijk worden vervolgd.
""")
            ]),
